...
public class Constants {
	...
	public static final String siteURL = "http://qa.capella.local/user/login";
	public static final String loginUser="dedeepya.n";
	...
	public static final String BROWSERSTACK_ACCESS_KEY = "sdsdsdfsf";
